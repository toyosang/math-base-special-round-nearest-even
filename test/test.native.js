...
tape( 'the function rounds to the nearest even integer for positive decimal values', opts, function test( t ) {
	var start = 0.0;
	var end = 100.0;
	var i;
...
tape( 'the function rounds to the nearest even integer for negative decimal values', opts, function test( t ) {
	var start = -100.0;
	var end = 0.0;
	var i;
